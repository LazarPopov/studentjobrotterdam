  ...
  return (
    <footer className="mt-10 border-t bg-white" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-8 sm:py-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {/* Brand */}
        <div>
          <div className="text-lg sm:text-xl font-semibold">Student Jobs Rotterdam</div>
          <p className="mt-2 text-sm text-slate-600 leading-relaxed">
            Student jobs, bijbaan tips, and local guides for Rotterdam. Find English friendly roles, compare pay, and
            apply fast.
          </p>
        ...
        {/* Explore */}
        <nav aria-label="Explore Student Jobs Rotterdam">
          ...
          <ul className="mt-3 space-y-2 text-sm">
            <li>
              <Link href="/blog/english-speaking-student-jobs-rotterdam" className="underline underline-offset-2">
                English Speaking Student Jobs in Rotterdam
              </Link>
            </li>
            <li>
    ...
    <nav aria-label="Student Jobs city network">
      ...
      <div className="bg-white border-t">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 py-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-3 text-xs text-slate-500">
          <div>© {year} Student Jobs Rotterdam. All rights reserved.</div>
