...
const NEW_JOBS: RawJob[] = [
...

  {
    ...
    englishFriendly: true,
    workHours: "14â€“40 h/week depending on vacancy",
    datePosted: "2026/02/14",
    validThrough: "2026-12-31",
    categories: ["delivery"],
...

  {
    ...
    orgName: "Flink",
    descriptionHtml:
      "<p>Pick and pack customer orders, restock shelves, and prepare deliveries. Apply via Flinkâ€™s picker/ops associate portal.</p>",
    employmentType: "PART_TIME",
    addressLocality: "Rotterdam",
    englishFriendly: true,
    workHours: "Flexible schedule (12â€“32 h/week typical)",
    datePosted: "2026/02/14",
    validThrough: "2026-12-31",
...

  {
    ...
    addressLocality: "Rotterdam",
    englishFriendly: true,
    workHours: "0.1â€“0.4 FTE depending on role",
    datePosted: "2026/02/14",
    validThrough: "2026-12-31",
    categories: ["tutoring"],
...

  {
    ...
    orgName: "Temper",
    descriptionHtml:
      "<p>Pick flexible shifts around Rotterdam in hospitality, events, logistics, and retail. Temper markets average earnings around â‚¬20 per hour (gross), depending on the shift.</p>",
...
const NEW_JOBS_2: RawJob[] = [
  {
    ...
    addressLocality: "Rotterdam",
    englishFriendly: true,
    workHours: "16â€“24 h/week (flexible shifts)",
    datePosted: "2026/02/14",
    validThrough: "2026-12-31",
    categories: ["hospitality"],
    externalUrl:
...

  {
    ...
    addressLocality: "Rotterdam",
    englishFriendly: true,
    workHours: "10â€“20 h/week (2â€“4 days, at least 3h/day)",
    datePosted: "2026/02/14",
    validThrough: "2026-12-31",
    categories: ["delivery"],
...

  {
    ...
    area: "Centrum",
    englishFriendly: true,
    workHours: "2â€“3 shifts/week (day or evening shifts)",
    datePosted: "2026/02/14",
    validThrough: "2026-12-31",
    categories: ["hospitality"],
    externalUrl:
...

  {
    ...
    descriptionHtml:
      "<p>Evening shifts (roughly 18:00â€“23:30). Help with prep, plating, cleaning, and receiving orders. Pay plus tips.</p>",
    employmentType: "PART_TIME",
    baseSalaryMin: 10.0,
    baseSalaryMax: 12.5,
    currency: "EUR",
    ...
    englishFriendly: true,
    workHours: "12â€“24 h/week (2 shifts/week)",
    datePosted: "2026/02/14",
    validThrough: "2026-12-31",
    categories: ["hospitality"],
    externalUrl:
...

  {
    ...
    area: "Near Rotterdam Centraal",
    englishFriendly: true,
    workHours: "8â€“16 h/week (2 shifts/week)",
    datePosted: "2026/02/14",
    validThrough: "2026-12-31",
    categories: ["hospitality"],
    externalUrl:
...

  {
    ...
    addressLocality: "Rotterdam",
    englishFriendly: true,
    workHours: "20â€“30 h/week (18â€“22 weeks)",
    datePosted: "2026/02/14",
    validThrough: "2026-12-31",
    categories: ["hospitality"],
    externalUrl:
...

  {
    ...
    descriptionHtml:
      "<p>Housekeeping shifts in Rotterdam centrum. Part-time role with 10â€“30 hours per week. Suitable for internationals with basic communication skills.</p>",
    employmentType: "PART_TIME",
    baseSalaryMin: 15.0,
    baseSalaryMax: 16.0,
    currency: "EUR",
