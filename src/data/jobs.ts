...
descriptionHtml: "<p><strong>Are you tired of endless study sessions and sitting behind your laptop all day?</strong> This job is your perfect excuse to get outside, stay active, and earn solid money while exploring your city! Join <strong>Thuisbezorgd.nl</strong> as a Food Delivery Courier - hop on your bike, scooter, or car, and deliver happiness (and food) straight to hungry customers.</p><ul><li><strong>Flexible schedule</strong> - choose your own working hours so you can balance lectures, gym time, and parties </li><li><strong>Reliable income</strong> - hourly pay + tips + bonuses (and yes, rainy-day deliveries pay even better)</li><li><strong>DUO-friendly</strong> - work enough hours and you can qualify for <strong>study financing (DUO)</strong> while keeping your freedom!</li><li><strong>Requirements</strong> - smartphone with data and your own bike, scooter, or car</li><li><strong>Perfect for students</strong> - stay fit, meet people, and make money on your own schedule</li></ul><p>Ready to swap your desk for the open road? <strong>Join Thuisbezorgd.nl and start earning this week!</strong></p>", employmentType: "PART_TIME",
 ...
 // perSaleAmountText: "150 euros per shift",
...
// externalUrl: "https://www.uber.com/signup/drive/deliver/?invite_code=a6cpc37",
  ...
  {
    "slug": "rocycle-rocycle-instructor-rotterdam-20250709",
    "title": "Rocycle Instructor",
    "orgName": "Cycle Concepts Holding B.V.",
    "descriptionHtml": "<p>Your qualifications First and foremost, we are looking to see you on that bike. With energy and love for celebrating your body through movement. We look for minds that are curious, open-minded and with a growth mindset. For humans who believe that self-love is the road to finding real joy in life and that the narrative of “summer bodies” should be left in the 90’s. We often attract those with a performance or sports background, but experience is not essential. For those who take their work seriously; are on time, work well within a team and are reliable. What we offer you We offer each instructor a training program, our 4 week training program is designed to give you the space to begin growing into the incredible rhythm cycling instructor we see in you. Guiding a room of 60+ humans through a fitness concept is a big responsibility, so we invest this time in sharing with you what you need to know to deliver not only a magical Ro’ride, but a safe one. The training program runs as follows: The first two weeks: Are full time training weeks, meaning that you will be training 4 - 5 weekdays between 13:00 - 16:00. You will be in the studio for 1,5 hours of each training session and workshopping for the remaining 1,5 hours. Online learning modules to learn the craft, at your own pace from home. Access to these will be given to you before the training begins. Expect that training these weeks will take approximately 30 hours per week The second two weeks: 2 x weekday in studio sessions per week from 13:00 - 16:00, the last session being your Community Ride. We ask that you participate in 4 rides per week so that you can learn from the existing...</p>",
    ...
    "englishFriendly": true,
    "DUO": true,
    "workHours": "Freelancer, Part-time",
    "datePosted": "2026-02-16",
    "categories": ["events"],
    "externalUrl": "https://rocycle.jobs.personio.com/job/1368033?language=en",
...

  {
    ...
    "datePosted": "2026-02-16",
    "categories": ["events"],
    "externalUrl": "https://rocycle.jobs.personio.com/job/1577845?language=en",
    "validThrough": "2026-03-23",
    "baseSalaryMin": 12.00,
    "baseSalaryMax": 16.00,
    "currency": "EUR",
...

  {
    ...
    "englishFriendly": true,
    "DUO": true,
    "workHours": "Intern / Student,Full or part-time",
    "datePosted": "2026-02-16",
    "categories": ["hospitality"],
    "externalUrl": "https://rocycle.jobs.personio.com/job/1398086?language=en",
...
import { NEW_JOBS } from "./newjobs_rotterdam";
