...
export const metadata: Metadata = {
  title: "Partners | Student Jobs Rotterdam",
  description:
    "Our SEO, community, and hiring partners helping students find great jobs in Rotterdam.",
  alternates: { canonical: "https://studentjobsrotterdam.nl/partners" },
  openGraph: {
    title: "Partners | Student Jobs Rotterdam",
    description:
      "Our SEO, community, and hiring partners helping students find great jobs in Rotterdam.",
    url: "https://studentjobsrotterdam.nl/partners",
    type: "website",
  },
};
...
const PARTNERS: Partner[] = [
  {
    ...
    url: "https://thestoragescanner.com/en-NL/cities/zuid-holland/rotterdam",
    descriptionHtml:
      `The leading independent platform in Rotterdam for comparing self-storage providers. Easily find and compare storage units and garage boxes by location, size, and price. Explore <a href="https://thestoragescanner.com/en-NL/cities/zuid-holland/rotterdam" target="_blank" rel="noopener noreferrer">self storage in Rotterdam</a> to choose the best option for your budget.`,
