...
const FAQS = [
  {
    question: "Do students in Rotterdam need a Dutch bank account?",
    answer:
  ...
  {
    question: "Why do students in Rotterdam care about iDEAL?",
    answer:
...
export const metadata: Metadata = {
  ...
  title: "Student Guide to Opening a Bank Account in Rotterdam (2026) | Student Jobs Rotterdam",
  description:
    "A practical guide for students moving to Rotterdam. Learn why a Dutch bank account helps with rent, salary payments, iDEAL, and everyday life in the Netherlands.",
  alternates: { canonical: CANONICAL },
  openGraph: {
    title: "Student Banking in Rotterdam: What You Need to Know",
    description:
      "Understand how Dutch banking works, what documents students usually need, and how to prepare for daily life in Rotterdam.",
    url: CANONICAL,
    type: "article",
    images: [{ url: `${BASE_URL}/blog/international-students-looking-for-English-speaking-jobs-near-Rotterdams-Erasmus-Bridge.jpg` }],
  },
};

export default function IngPageRotterdam() {
  const faqJsonLd = {
  ...
  const articleJsonLd = {
    "@context": "https://schema.org",
    "@type": "Article",
    headline: "Opening a Dutch Bank Account in Rotterdam: A Practical Student Guide",
    description:
      "A practical guide for students moving to Rotterdam. Learn why a Dutch bank account helps with rent, salary payments, iDEAL, and everyday life in the Netherlands.",
    datePublished: PUBLISH_DATE,
    dateModified: MODIFIED_DATE,
    mainEntityOfPage: CANONICAL,
    image: [`${BASE_URL}/blog/international-students-looking-for-English-speaking-jobs-near-Rotterdams-Erasmus-Bridge.jpg`],
    author: {
      "@type": "Organization",
      name: "Student Jobs Rotterdam Editorial",
    },
    publisher: {
      "@type": "Organization",
  ...
  const navItems = [
    ...
    { id: "city", label: "Banking in Rotterdam" },
    ...
    <article className="mx-auto max-w-7xl px-4 py-8 text-slate-800 sm:px-6 lg:px-8 lg:py-12">
      ...
      <header className="mb-10 border-b border-slate-200 pb-8">
        ...
        <h1 className="mb-6 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl lg:text-5xl">
          Opening a Dutch Bank Account in Rotterdam: A Practical Student Guide
        </h1>

        <p className="max-w-3xl text-base leading-7 text-slate-600 sm:text-lg sm:leading-8">
          If you are moving to <strong>Rotterdam</strong> for your studies, setting
        ...
        <div className="mt-6 flex flex-wrap gap-x-3 gap-y-2 text-sm text-slate-500">
          ...
          <span className="hidden sm:inline">|</span>
          <span>By Student Jobs Rotterdam Editorial</span>
        </div>
      </header>
        ...
        <div className="space-y-12 text-base leading-7 sm:text-lg sm:leading-8">
          <section id="why" className="scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-slate-900">
              Why students in Rotterdam often open a Dutch bank account
            </h2>
            ...
            <p>
              ...
              account. However, for many students in <strong>Rotterdam</strong>,
          ...
          >
            <h2 className="mb-4 text-2xl font-bold text-slate-900">
              Banking as a student in Rotterdam
            </h2>

            <p className="mb-6 text-slate-700">
              Stop staring at the skyline and start building your bank balance. Rotterdam rewards the hustle, but only if you have a Dutch bank account to receive the payout.
            </p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div>
                ...
                <p className="text-sm leading-6 text-slate-700 sm:text-base">
                  Bold, architectural, and driven by a relentless 'geen woorden maar daden' (actions, not words) mentality. Erasmus students here hustle hard and play hard.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm leading-6 text-slate-700 sm:text-base">
                  The port city offers massive logistics roles, but there are also trendy shifts waiting at the Markthal, Witte de Withstraat bars, or flexible gig-economy apps.
                </p>
              </div>
            </div>

            <div className="mt-6 border-t border-slate-200 pt-6 text-sm italic text-slate-700 sm:text-base">
              <strong>Local note for Rotterdam:</strong> Rotterdammers value efficiency. Having the ING app ready with Apple Pay means you can tap in and out of the metro or grab a quick kapsalon without fumbling for cash or waiting for foreign card approvals.
            </div>
          </section>
