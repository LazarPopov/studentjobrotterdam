...
export const metadata: Metadata = {
  ...
  title: "Top English News Sources in the Netherlands (2026) | Living in Rotterdam | Student Jobs Rotterdam",
  description:
    "Trying to keep up with Dutch news in English? We review the best platforms for 2026, including Dutch Brief, DutchNews.nl, and local Rotterdam resources.",
  keywords: [
    "Dutch Brief",
    "Dutch news in English 2026",
    "English language news Netherlands",
    "expat news Rotterdam",
  ...
  openGraph: {
    ...
    description:
      "A curated guide for internationals in Rotterdam. From the Dutch Brief newsletter to deep-dive investigative sites, here's how to stay in the loop.",
    url: CANONICAL,
    type: "article",
    locale: "en_NL",
  ...
  twitter: {
    ...
    description:
      "Stop relying on Google Translate. Discover the top English-language news outlets for expats in Rotterdam.",
    images: [OG_IMAGE_URL],
  },
};

export default function NetherlandsNewsInEnglishRotterdam() {
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <header className="max-w-3xl">
          ...
          <p className="mt-4 text-lg text-slate-700 leading-relaxed">
            For internationals living in <strong>Rotterdam</strong>, keeping up with local policy, housing laws, and national news can be a challenge. You shouldn't have to rely on clunky browser translations to know what's happening in your own backyard.
          </p>
        ...
        <div className="mt-12 grid gap-12 lg:grid-cols-[1fr_320px]">
          ...
          <nav aria-label="Table of contents" className="order-1 lg:order-2 lg:sticky lg:top-24 h-max rounded-2xl border p-6 bg-slate-50">
            ...
            <ul className="mt-4 space-y-3 text-sm font-medium text-slate-600">
              ...
              <li><a href="#students" className="hover:text-blue-600">Tips for Rotterdam students</a></li>
          ...
          <article className="order-2 lg:order-1 max-w-3xl space-y-8 leading-relaxed text-slate-800 text-lg">
            <section id="why">
              ...
              <p>
                Navigating the Netherlands as an international often means missing the "fine print" of society. Whether it's a sudden change in 30% ruling policies or a local transit strike in <strong>Rotterdam</strong>, having a source that translates not just the words, but the <em>context</em>, is vital. The platforms below have moved beyond simple translation; they offer curation specifically for the expat experience.
              </p>
            </section>
            ...
            <section id="alternatives">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="mt-2">More than just news, <strong>IamExpat</strong> is about utility. Their news section is heavily filtered to focus on housing, taxes, and career opportunities—perfect for those still settling into <strong>Rotterdam</strong>.</p>
                </div>
              </div>
            </section>
            ...
            <section id="students">
              <h2 className="text-2xl font-bold text-slate-900">For Students in Rotterdam</h2>
              <p>
            ...
            <section id="faq" className="pt-8 border-t">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="mt-2 text-slate-600 text-base">They offer a robust free newsletter, which is why it has become so popular among the international community in cities like Rotterdam.</p>
                </div>
              </div>
            </section>
          </article>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description: "A comprehensive review of English news sources for internationals living in Rotterdam.",
              image: [OG_IMAGE_URL],
