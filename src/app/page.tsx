...
export const metadata: Metadata = {
  title: "Student Jobs in Rotterdam (2026) | Part-Time & English-Friendly Work",
  description:
  ...
  openGraph: {
    title: "Student Jobs in Rotterdam (2026)",
    description:
  ...
  const blogPosts = [
    {
      ...
      title:
        "Studenten bijbaan Rotterdam (2026) – Goed betaald, Engelstalig & weekend",
      excerpt:
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                <h1 className="text-3xl md:text-5xl font-semibold text-white">
                  Student Jobs in Rotterdam (2026)
                </h1>
