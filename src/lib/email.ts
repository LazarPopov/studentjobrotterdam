...
export async function sendJobSubmissionNotification(data: JobSubmissionEmailData): Promise<void> {
    ...
    <body>
      <div class="container">
        <div class="header">
          ...
          <p style="margin: 5px 0 0 0; opacity: 0.9;">Student Jobs Rotterdam</p>
        </div>
        ...
        <div class="footer">
          <p>This is an automated notification from Student Jobs Rotterdam</p>
  ...
  const textContent = `
New Job Submission - Student Jobs Rotterdam
==========================================
...
Received at ${new Date().toLocaleString('nl-NL', { timeZone: 'Europe/Amsterdam' })}
  ...
  const mailOptions = {
    from: `"${process.env.GMAIL_FROM_NAME || 'Student Jobs Rotterdam'}" <${process.env.GMAIL_FROM_ADDRESS || process.env.GMAIL_USERNAME}>`,
    ...
    <body>
      <div class="container">
        <div class="header">
          ...
          <p style="margin: 10px 0 0 0; opacity: 0.9;">Student Jobs Rotterdam</p>
        </div>
        ...
        <div class="content">
          ...
          <ol>
            ...
            <li>Once approved, your job will be published on Student Jobs Rotterdam</li>
          ...
          <p>Best regards,<br>
          <strong>Student Jobs Rotterdam Team</strong></p>
        </div>
        
        <div class="footer">
          <p>Student Jobs Rotterdam | Connecting students with opportunities</p>
          <p><a href="https://studentjobsrotterdam.nl">studentjobsrotterdam.nl</a></p>
        </div>
      </div>
    </body>
    </html>
