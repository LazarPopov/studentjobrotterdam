...
export const metadata: Metadata = {
  title: "Best-Paying Student Jobs in Rotterdam (2025) — Shift Types, Industries & Certifications",
  description:
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <nav aria-label="Table of contents" className="mt-6 rounded-2xl border p-4 bg-slate-50">
          ...
          <ul className="mt-2 list-disc pl-5 text-sm text-slate-700 space-y-1">
            <li><a href="#top-categories" className="underline">Top-paying categories for students</a></li>
            <li><a href="#shift-bonuses" className="underline">Shift bonuses that boost pay</a></li>
            <li><a href="#certifications" className="underline">Certifications that add €€</a></li>
            <li><a href="#quick-wins" className="underline">Quick wins to raise your rate</a></li>
            <li><a href="#example-paths" className="underline">Example upgrade paths</a></li>
            <li><a href="#apply-now" className="underline">Apply now (high-paying filters)</a></li>
        ...
        <article className="prose prose-slate max-w-none mt-8">
          ...
          <ul>
            <li>
              ...
              <Link href="/categories/tutoring" className="underline">Tutoring jobs</Link>.
            </li>
            <li>
            ...
            <li>
              <strong>Sales with Commission</strong> — base + bonuses (door-to-door, call/chat, retail add-ons). Check{" "}
          ...
          <p>
            You can increase your net hourly rate just by choosing the right schedule:
          </p>
          <ul>
            <li>
          ...
          <p>
            Short, affordable certificates can move you from entry-level to higher-paid shifts:
          </p>
          <ul>
            <li><strong>BHV</strong> (bedrijfshulpverlening / first aid + emergency response) — useful in events/hospitality.</li>
            <li><strong>HACCP</strong> — food safety; increases trust for café/restaurant/kitchen roles.</li>
            <li><strong>VCA</strong> — safety standard often requested for fieldwork/logistics/event build-up.</li>
            <li><strong>Forklift (heftruck)</strong> — relevant for warehouses; tends to unlock higher-paying slots.</li>
            <li><strong>Barista training</strong> — moves you up the hospitality ladder quickly.</li>
          </ul>
          ...
          <ul>
            ...
            <li>
              <strong>Pitch availability upfront</strong> (reliability = better shifts). Use our template in applications.
            </li>
            <li>
          ...
          <ol>
            <li>
              <strong>Hospitality runner → Barista → Shift lead</strong>: take a weekend barista course, then ask to be
              scheduled on machine + close shifts (usually higher pay).
            </li>
            <li>
          ...
          <div className="rounded-2xl border p-5 bg-white">
            ...
            <p className="mt-1">
              ...
              <Link href="/jobs?english=true" className="underline">English-friendly only</Link>, and browse{" "}
              <Link href="/categories" className="underline">categories</Link>. If you’re an employer,{" "}
          ...
          <p>
            Often tutoring, logistics evening/night shifts, event leads, and sales with commission. Skilled hospitality
            (barista/lead) also earns more than entry roles.
          </p>

          <h3>How can I quickly increase my hourly rate?</h3>
          <p>
            Target shifts with allowances, get a short certificate (BHV, VCA, forklift, barista), and ask for duties with
            responsibility (team lead, machine operator, keyholder).
          </p>
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 2, name: "Best-Paying Student Jobs in Rotterdam (2025)", item: CANONICAL },
              ],
            }),
          }}
        />
