...
export const metadata: Metadata = {
  ...
  description:
    "Discover the best-paying student jobs in Rotterdam for 2026: evening/weekend shifts, logistics, tutoring, events lead roles, and certifications like BHV, HACCP, VCA, forklift.",
  keywords: [
